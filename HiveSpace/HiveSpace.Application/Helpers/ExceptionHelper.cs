...
public class ExceptionHelper
{
    ...
    {
        return innerException is null
            ? new BaseException(CreateErrorCodeList(errorCode, errorData), httpCode, errorData is not null)
            : new BaseException(CreateErrorCodeList(errorCode, errorData), innerException, httpCode, errorData is not null);
    }
